...
public abstract class StringUtil
{
     ...
     */
    public static String toScriptUnicode(String strText)
        throws UnsupportedEncodingException
    {
     ...
     * @return 转换后的Unicode码字符串
     */
    public static String toScriptUnicode(String strText, String code)
        throws UnsupportedEncodingException
    {
        char c;
    ...
    public static String replaceVariables(String original, HashMap<String, String> variables)
    {
        ...
        try
        {
            ...
            for (String k : key)
            {
                original = original.replaceAll("\\$\\{" + k + "\\}", variables.get(k));
            }
        }
        catch (Exception e)
        {
            logger.error("无法对字符串的变量进行替换:" + original, e);
        }
